        ...
        <div className="container py-8 lg:py-12">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-2">
              {course.bestseller && <span className="udemy-badge-bestseller">Bestseller</span>}
      ...
      <div className="container py-8">
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                    <span className="flex items-center gap-1"><BarChart3 className="h-3.5 w-3.5" /> 4.7 Instructor Rating</span>
          ...
          <div className="lg:w-80">
            <div className="lg:sticky lg:top-20 border bg-card" style={{ boxShadow: "var(--shadow-sticky)" }}>
              ...
              <div className="p-6">
                ...
                <Link to={`/checkout/${course.id}`}>
                  <Button variant="udemy" className="w-full h-12 text-base mb-2">
                    Buy now
                  </Button>
                </Link>
                <Button variant="udemy-outline" className="w-full h-12 text-base mb-4">
                  Add to cart
                </Button>
